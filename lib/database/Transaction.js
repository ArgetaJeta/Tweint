...
// The Transaction component that takes transaction details and displays them
const Transaction = ({ transaction, isOutgoing }) => {
  // Destructure `t` for translations and `theme` for theming from the hooks
  const { t } = useTranslation();
  const theme = useTheme();
 
  // Styles for the transaction container and its child components
